...
C_BASE_FLAGS = [
        ...
        '-std=c11',
        '-I/usr/lib/',
        '-I/lib/modules/5.4.0-28-generic/build',
        '-I/lib/modules/5.4.0-28-generic/build/include/linux/linkage.h',
        '-I/lib/modules/5.4.0-28-generic/build/include',
        '-isystem/lib/modules/5.4.0-28-generic/build/include',
        '-I/usr/include/'
        ]
